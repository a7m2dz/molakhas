export const sections = [
  ...
  { slug: 'movies', name: 'الأفلام', icon: '/brand/icon-movies.svg', description: 'أخبار الأفلام العربية والأجنبية، الجديد ومواعيد العرض.' },
  { slug: 'tv', name: 'المسلسلات', icon: '/brand/icon-tv.svg', description: 'أخبار المسلسلات العربية والأجنبية، المواسم والحلقات ومواعيد العرض.' },
